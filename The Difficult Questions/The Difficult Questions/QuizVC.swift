...
class QuizVC: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        let que1 = Question(imgName: "img1", questionText: "Where is the World’s longest sea bridge ?", options: ["Japan", "Russia", "China", "None of the above"], correctAns: 2, wrongAns: -1, isAnswered: false)
        let que2 = Question(imgName: "img2", questionText: "Where is the world’s oldest university?", options: ["Fez Morocco", "Harvard University", "Oxford University", "None"], correctAns: 0, wrongAns: -1, isAnswered: false)
        let que3 = Question(imgName: "img1", questionText: "Which is the world’s oldest democracy?", options: ["India", "UK","GREECE","None of the above."], correctAns: 2, wrongAns: -1, isAnswered: false)
        let que4 = Question(imgName: "img2", questionText: "Which is the continuously World’s oldest Democracy?", options: ["UK.", "USA","INDIA","None"], correctAns: 0, wrongAns: -1, isAnswered: false)
        let que5 = Question(imgName: "img1", questionText: "The oldest written plan of government in effect is in which country?", options: ["USA","UK","Sweden","None"], correctAns: 0, wrongAns: -1, isAnswered: false)
        let que6 = Question(imgName: "img2", questionText: "The oldest written constitution of government in effect in which country?", options: ["UK.", "Canada.","USA","None"], correctAns: 2, wrongAns: -1, isAnswered: false)
        
         let que7 = Question(imgName: "img2", questionText: "Which country was the first to make sealt belts compulsory for journey?", options:["China","Czechoslovakia","France","None"] , correctAns: 1, wrongAns: -1, isAnswered: false)
        
          let que8 = Question(imgName: "img2", questionText: "In which country were modern banknotes first used?", options: ["Sweden","France","China","None"], correctAns: 0, wrongAns: -1, isAnswered: false)
          let que9 = Question(imgName: "img2", questionText: "Which was the first country to leave the UN?", options: ["Iran", "Ghana","Indonesia","None"], correctAns: 2, wrongAns: -1, isAnswered: false)
       
        questionsArray = [que1, que2, que3, que4, que5, que6,que7,que8,que9]
